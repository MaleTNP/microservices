package com.thanapongBank.gatewayserver.config;
...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityChain(ServerHttpSecurity serverHttpSecurity) {
        serverHttpSecurity.authorizeExchange(exchange -> exchange.pathMatchers(HttpMethod.GET).permitAll()
                .pathMatchers("/malebank/accounts/**").hasRole("ACCOUNTS")
                .pathMatchers("/malebank/cards/**").hasRole("CARDS")
                .pathMatchers("/malebank/loans/**").hasRole("LOANS"))
