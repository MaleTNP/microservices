...
import com.thanapongBank.accounts.dto.AccountsMsgDto;
...
import com.thanapongBank.accounts.exception.CustomerAlreadyExistsException;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        if (optionalCustomer.isPresent()) {
            throw new CustomerAlreadyExistsException("Customer already registered with given moblieNumber "
    ...
    private void sendCommunication(Accounts account, Customer customer) {
        ...
        log.info("Is the Communication reqeust successfully triggered? : {}", result);
    }
